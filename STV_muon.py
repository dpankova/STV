...
tray.AddSegment(Mods.DoTrackHits,"DoTH_Free", #Run Starting TrackVeto on Seed_Fit
                Pulses=pulses,
                FitNames=[seed_fit],
...
tray.Add(Utils.CleanTH,"CleanTHFree",
         Pulses=pulses,
         FitNames=[seed_fit])
...
tray.AddSegment(Mods.DoTrackHits,"DoTH_Prim", #Run Starting TrackVeto on prim
                Pulses=pulses,
                FitNames=[prim+"Orig"],
                NSeg=n_segments_free,
                Percent=0.01,
...
tray.Add(Utils.CleanTH,"CleanTHPrimOrig",
         Pulses=pulses,
         FitNames=[prim+"Orig"])
...
tray.AddSegment(Mods.DoTrackHits,"DoTH_Veto", #Run Starting TrackVeto on Seed_Fit
                Pulses=pulses,
                FitNames=TrackNames,
                NSeg=n_segments_free,
                Percent=0.01,
